...
j := i // j is an int
   ...
   variable may be an `int`, `float64`, or `complex128` depending on the
...
g := 0.867 + 0.5i // complex128
   ...
   Try changing the initial value of `v` in the example code and observe how
   its type is affected */
func main() {
	v := 42i // Change me!
